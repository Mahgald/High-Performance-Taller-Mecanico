...
body{
	...
	<div class="col-md-8 col-md-offset-2">
		...
		<h1>Nueva Orden de Trabajo</h1><br><br>

		<form:form action="../OrdenTrabajo/NuevaOrden" method="post" class="form-horizontal" modelAttribute="ordenNueva">
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:input class="form-control" path="fecha" placeholder="aaaa-mm-dd" />
					<br>
				</div>
			</div>

			<div class="form-group">
				<form:label class="control-label col-sm-2" path="detalle_Falla">Detalle de la Falla: </form:label>
				<div class="col-sm-6">
					<form:textarea class="form-control" path="detalle_Falla" />
					<br>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-6">
					<form:select class="form-control" path="empleado.id">
			...
			<div class="form-group">
				<div class="col-sm-6 col-sm-offset-2">
					<input type="submit" class="btn btn-danger form-control" value="Agregar Orden" />
