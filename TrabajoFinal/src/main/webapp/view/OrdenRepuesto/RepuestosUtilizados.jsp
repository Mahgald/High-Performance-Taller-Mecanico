			...
			<div id="navbar" class="collapse navbar-collapse">
				<ul class="nav navbar-nav">
					...
					<li><a href="<%=request.getContextPath()%>/Repuesto/">Lista
							Repuestos</a></li>
					<li><a href="<%=request.getContextPath()%>/OrdenTrabajo/">Lista
...
body {
	...
	<div class="container">
		...
		<button type="button" class="btn btn-primary" data-toggle="modal"
			data-target="#agregarRepuesto">Agregar</button>
		<a class="btn btn-danger"
			href="<%=request.getContextPath()%>/OrdenTrabajo/TrabajosSinTerminar">Volver</a>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form:form action="../Agregar" method="post"
						modelAttribute="ordenRepuesto" class="form-horizontal formulario"
						id="formularioRepuesto">
	...
	<script
		src="<%=request.getContextPath()%>/resources/js/agregarRepuesto.js"></script>
